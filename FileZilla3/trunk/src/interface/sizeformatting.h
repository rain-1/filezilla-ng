...
public:
	...
	static wxString GetUnit(_unit unit, _format = formats_count);
	static wxString FormatUnit(int64_t size, _unit unit, int base = 1024);

	static wxString Format(int64_t size, bool add_bytes_suffix, _format format, bool thousands_separator, int num_decimal_places);
