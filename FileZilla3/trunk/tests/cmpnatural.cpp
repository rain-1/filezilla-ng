...
{
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T(""), _T("")) == 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T(""), _T("x")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("x"), _T("")) > 0);
}

void CNaturalSortTest::testCaseInsensitive()
{
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("a"), _T("A")) == 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("B"), _T("b")) == 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("a"), _T("B")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("A"), _T("b")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("afFasFAc"), _T("aFfaSFaC")) == 0);
}

void CNaturalSortTest::testString()
{
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("a"), _T("b")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("b"), _T("a")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("a"), _T("ab")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("ab"), _T("a")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("affasfac"), _T("affasfac")) == 0);
}

void CNaturalSortTest::testNumber()
{
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("1"), _T("1")) == 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("1"), _T("2")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("2"), _T("1")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("15"), _T("25")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("25"), _T("15")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("15"), _T("17")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("17"), _T("15")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("1"), _T("10")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10"), _T("1")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("2"), _T("17")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("17"), _T("2")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("2"), _T("02")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("02"), _T("2")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("02"), _T("1")) > 0);
...
{
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("0"), _T("a")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("a"), _T("0")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("abc1xx"), _T("abc2xx")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("abc1bb"), _T("abc2aa")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("abc2"), _T("1")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10abc"), _T("10def")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10def"), _T("10abc")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10abc2"), _T("10abc3")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10abc3"), _T("10abc2")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10abc"), _T("10abc3")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("10abc3"), _T("10abc")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("1"), _T("1abc")) < 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("1abc"), _T("1")) > 0);
	CPPUNIT_ASSERT(CListViewSort::CmpNatural(_T("2"), _T("1abc")) > 0);
